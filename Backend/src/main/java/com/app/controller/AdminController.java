...
//delete trainner by id 
    ...
    public ResponseEntity<MachineDTO> editMachineStatus(@PathVariable long id, @RequestParam boolean isAvailable) {
        try {
            // Call service method to update machine status
            MachineDTO updatedMachine = machineService.updateMachineStatus(id, isAvailable);
