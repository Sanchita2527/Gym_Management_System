  ...
  const formik = useFormik({
    ...
    onSubmit: async (values) => {
      try {
        ...
        if (user1.authenticatedDetails.principal.role === "ROLE_MEMBER") navigate("/customer");
        else if (user1.authenticatedDetails.principal.role === "ROLE_ADMIN") navigate("/admin");
        else if (user1.authenticatedDetails.principal.role === "ROLE_TRAINER") navigate("/trainer");
      } catch (error) {
  ...
  return (
    ...
    >
      ...
      <div className="d-flex justify-content-center align-items-center vh-100">
        ...
        >
          <h2 className="text-center mb-4">Login to GYM-X</h2>
